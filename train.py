...
class ModelArguments:
    ...
    lmbd1: float = field(
        default=0.5, 
        metadata={"help": "For training NT-Xent obejective function in supervised contrastive learning"}
    )
    lmbd2: float = field(
        default=0.5, 
        metadata={"help": "For training entailment relationsihp in supervised contrastive learning"}
    )
...
def main():
    ...
    if len(column_names) == 2:
        ...
        # Pair datasets for supcon
        sent0_cname = column_names[0]
        sent1_cname = column_names[1]
        sent2_cname = column_names[2]
        sent3_cname = column_names[3]
    elif len(column_names) == 5:
        # Pair datasets for supcon and contradiction
        sent0_cname = column_names[0]
        sent1_cname = column_names[1]
        sent2_cname = column_names[2]
        sent3_cname = column_names[3]
        sent4_cname = column_names[4]
    elif len(column_names) == 6:
        # Pair datasets for supcon and contradiction
        sent0_cname = column_names[0]
        sent1_cname = column_names[1]
        sent2_cname = column_names[2]
    ...
    def prepare_features(examples):
        ...
        if sent5_cname is not None:
            for idx in range(total):
                if examples[sent5_cname][idx] is None:
                    examples[sent5_cname][idx] = " "
            sentences += examples[sent5_cname]
